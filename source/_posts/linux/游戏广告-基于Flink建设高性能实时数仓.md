...
<p class="toc-enable" style="">&nbsp; &nbsp; &nbsp; &nbsp;而在多年以来数据的开发模式主要是烟囱式的开发模式，产品提需求，开发做需求，以致于会有很多重复的开发工作、代码没有统一，维护困难。以下是现在的开发架构：<br><img src="/logbook/images/linux/游戏广告-基于Flink建设高性能实时数仓/f5428f1b7fcf.png" style="display: block; margin-left: auto; margin-right: auto; position: relative; z-index: 2;" alt="" class="amplify"></p>
...
<p style=""><img src="/logbook/images/linux/游戏广告-基于Flink建设高性能实时数仓/abe45ee8e95c.jpg" style="display: block; margin-left: auto; margin-right: auto; position: relative; z-index: 2;" alt=""></p>
...
<p style=""><img src="/logbook/images/linux/游戏广告-基于Flink建设高性能实时数仓/f8c1374a31a4.jpg" style="display: block; margin-left: auto; margin-right: auto; position: relative; z-index: 2;" alt=""></p>
<p style="text-align:center;">注，<a href="https://libertydream.github.io/2020/04/12/lambda-%E5%92%8C-kappa-%E7%AE%80%E4%BB%8B/" target="_blank" rel="noreferrer">图片来自网络</a></p>
...
<p style=""><img src="/logbook/images/linux/游戏广告-基于Flink建设高性能实时数仓/d39cc9c8270e.png" style="display: block; margin-left: auto; margin-right: auto; position: relative; z-index: 2;" alt="" class="amplify"></p>
<p>如上图所示，从下往上分别是：</p>
...
<p style=""><img src="/logbook/images/linux/游戏广告-基于Flink建设高性能实时数仓/db9cb43b558d.png" style="display: block; margin-left: auto; margin-right: auto; position: relative; z-index: 2;" alt="" class="amplify"></p>
...
<p style=""><img src="/logbook/images/linux/游戏广告-基于Flink建设高性能实时数仓/1ba6787bfd72.png" style="display: block; margin-left: auto; margin-right: auto; position: relative; z-index: 2;" alt="" class="amplify"></p>
...
<p style=""><img src="/logbook/images/linux/游戏广告-基于Flink建设高性能实时数仓/437dbdaab9f9.png" style="display: block; margin-left: auto; margin-right: auto; position: relative; z-index: 2;" alt="" class="amplify"></p>
...
<p style=""><img src="/logbook/images/linux/游戏广告-基于Flink建设高性能实时数仓/858792e3a03a.png" style="display: block; margin-left: auto; margin-right: auto; position: relative; z-index: 2;" alt="" class="amplify"></p>
...
<p style=""><img src="/logbook/images/linux/游戏广告-基于Flink建设高性能实时数仓/74034bc81fc0.png" alt="" style="position: relative; z-index: 2;" class="amplify"></p>
<p>如上图所示：</p>
...
<p style=""><img src="/logbook/images/linux/游戏广告-基于Flink建设高性能实时数仓/6ea167b78308.png" alt="" style="position: relative; z-index: 2;" class="amplify"></p>
...
<p style=""><img src="/logbook/images/linux/游戏广告-基于Flink建设高性能实时数仓/6acbb59f1274.png" alt="" style="position: relative; z-index: 2;" class="amplify"></p>
...
<p style=""><img src="/logbook/images/linux/游戏广告-基于Flink建设高性能实时数仓/21a464f1fa32.png" alt="" style="position: relative; z-index: 2;" class="amplify"></p>
...
<p style=""><img src="/logbook/images/linux/游戏广告-基于Flink建设高性能实时数仓/309633a1dd3c.png" alt="" style="position: relative; z-index: 2;" class="amplify"></p>
<p><strong>Flink Source端：</strong>读取TDBank的数据，如读取DWS层轻度聚合的数据。</p>
...
<p>使用proxy分布式表查询：</p>
<p style=""><img src="/logbook/images/linux/游戏广告-基于Flink建设高性能实时数仓/66ed174902cd.png" alt="" style="position: relative; z-index: 2;" class="amplify"></p>
...
<p style=""><img src="/logbook/images/linux/游戏广告-基于Flink建设高性能实时数仓/2823ac9af6c3.png" width="435" height="392" style="display: block; margin-left: auto; margin-right: auto; position: relative; z-index: 2;" alt=""></p>
...
<p><br></p>
<p style=""><img src="/logbook/images/linux/游戏广告-基于Flink建设高性能实时数仓/e2f168fab003.png" width="753" height="268" alt="" style="position: relative; z-index: 2;" class="amplify"></p>
...
<p style=""><img src="/logbook/images/linux/游戏广告-基于Flink建设高性能实时数仓/b53bc9c9ccec.png" width="448" height="358" style="display: block; margin-left: auto; margin-right: auto; position: relative; z-index: 2;" alt=""></p>
...
<p style=""><img src="/logbook/images/linux/游戏广告-基于Flink建设高性能实时数仓/3cfe99b5e3bd.png" width="532" height="414" style="display: block; margin-left: auto; margin-right: auto; position: relative; z-index: 2;" alt=""></p>
...
<p style=""><img src="/logbook/images/linux/游戏广告-基于Flink建设高性能实时数仓/be6150614ca7.png" alt="" style="position: relative; z-index: 2;"></p>
...
<p style=""><img src="/logbook/images/linux/游戏广告-基于Flink建设高性能实时数仓/dd16ebfbd922.png" width="721" height="368" style="display: block; margin-left: auto; margin-right: auto; position: relative; z-index: 2;" alt="" class="amplify"></p>
...
<p style="">以10w QPS的量为例，优化后仅使用了20核（图中并行度为19个），80G。且无算子倾斜和反压现象。下图为优化后的flink topo计算部分截图：<br><img src="/logbook/images/linux/游戏广告-基于Flink建设高性能实时数仓/c8a67d84d1ea.png" alt="" style="position: relative; z-index: 2;"></p>
<p style="">也就是，优化后，将原任务CPU为400核节省至20核，从内存1.6T优化至80G。<br><img src="/logbook/images/linux/游戏广告-基于Flink建设高性能实时数仓/a008ce907672.png" alt="" style="position: relative; z-index: 2;" class="amplify"></p>
...
<p style=""><img src="/logbook/images/linux/游戏广告-基于Flink建设高性能实时数仓/4d1c0d9b14c0.png" style="display: block; margin-left: auto; margin-right: auto; position: relative; z-index: 2;" alt=""></p>
...
<p style=""><img src="/logbook/images/linux/游戏广告-基于Flink建设高性能实时数仓/607bc569e8b3.png" style="display: block; margin-left: auto; margin-right: auto; position: relative; z-index: 2;" alt=""></p>
...
<p style=""><img src="/logbook/images/linux/游戏广告-基于Flink建设高性能实时数仓/20aa20ca77d8.png" alt="" style="position: relative; z-index: 2;" class="amplify"></p>
...
<p style=""><img src="/logbook/images/linux/游戏广告-基于Flink建设高性能实时数仓/87e7adfdb14a.png" alt="" style="position: relative; z-index: 2;"></p>
...
<p style=""><img src="/logbook/images/linux/游戏广告-基于Flink建设高性能实时数仓/39ea42026ca0.png" width="524" height="217" style="display: block; margin-left: auto; margin-right: auto; position: relative; z-index: 2;" alt=""></p>
<p><br></p>
...
<p style=""><img src="/logbook/images/linux/游戏广告-基于Flink建设高性能实时数仓/c0c601b9a63b.png" style="display: block; margin-left: auto; margin-right: auto; position: relative; z-index: 2;" alt=""></p>
...
<p style=""><img src="/logbook/images/linux/游戏广告-基于Flink建设高性能实时数仓/867d75178dcb.png" style="display: block; margin-left: auto; margin-right: auto; position: relative; z-index: 2;" alt=""><strong>优化效果</strong></p>
<p>在对维表关联进行了配置同步优化、维表关联优化两大改进措施之后，可以看到优化后的效果是非常明显的。如下图所示：</p>
<div class="table-wrap"><strong><strong><strong><strong><strong><strong style=""><img src="/logbook/images/linux/游戏广告-基于Flink建设高性能实时数仓/622cf7315bdb.png" style="display: block; margin-left: auto; margin-right: auto; position: relative; z-index: 2;" alt="" class="amplify"></strong></strong></strong></strong></strong></strong><strong><strong><strong><strong><strong><br></strong></strong></strong></strong></strong></div>
...
<p style=""><img src="/logbook/images/linux/游戏广告-基于Flink建设高性能实时数仓/59b7d54167d8.png" style="display: block; margin-left: auto; margin-right: auto; position: relative; z-index: 2;" width="431" height="105" alt=""></p>
