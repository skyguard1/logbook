...
<pre class="language-" style="position: relative; z-index: 2;"><code class="prism language-">doc1: hello world
doc2: hello golang
...
<p style=""><img src="./ElasticSearch 数据结构 - KM平台_files/cos-file-url(1)" style="display: block; margin-left: auto; margin-right: auto; position: relative; z-index: 2;" alt="" class="amplify"></p>
<p></p>
<p style=""><img src="./ElasticSearch 数据结构 - KM平台_files/cos-file-url(2)" style="display: block; margin-left: auto; margin-right: auto; position: relative; z-index: 2;" alt="" class="amplify"></p>
...
<p><strong style=""><img src="./ElasticSearch 数据结构 - KM平台_files/cos-file-url(3)" style="display: block; margin-left: auto; margin-right: auto; position: relative; z-index: 2;" alt="" class="amplify"></strong></p>
...
<p style=""><img src="./ElasticSearch 数据结构 - KM平台_files/cos-file-url(4)" style="display: block; margin-left: auto; margin-right: auto; position: relative; z-index: 2;" alt=""></p>
...
<p style=""><img src="./ElasticSearch 数据结构 - KM平台_files/cos-file-url(5)" style="display: block; margin-left: auto; margin-right: auto; position: relative; z-index: 2;" alt=""></p>
...
<p style=""><img src="./ElasticSearch 数据结构 - KM平台_files/cos-file-url(6)" style="display: block; margin-left: auto; margin-right: auto; position: relative; z-index: 2;" alt=""></p>
...
<p style=""><img src="./ElasticSearch 数据结构 - KM平台_files/cos-file-url(7)" style="display: block; margin-left: auto; margin-right: auto; position: relative; z-index: 2;" alt=""></p>
